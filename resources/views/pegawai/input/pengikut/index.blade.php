...
@if(count($event) > '0')
<form action="{{ route('belum-event_validasi.event', ['id' => $id->id]) }}">
    <input type="submit" value="Kembali" />
</form>
@endif

<form method="POST" id="myForm" name="vform" onsubmit="return Validate()" action="{{ route('add-pengikut.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
        ...
        <hr style="border-width: 2px; border-color: black;"></hr>
            ...
            <div class="event">
              ...
              <div class="transportasi">
                <input hidden required type="number" min="1" id="lama" name="lama" value="{{$id->lama}}"></input>
            ...
            <div class="event">
              ...
              <select hidden id="angkut" name="akun" required>
                ...
                <div id="HN" class="form-group">
                  ...
                  <input min="0" id="hn-jml" name="j_hn" min="0" type="number" placeholder="Jumlah" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"></input>
