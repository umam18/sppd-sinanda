...
<!-- Main content -->
  ...
  <div class="box-header">
        ...
        <div class="row" style="width: 1070px; margin-left: 5px;">
          <div class="alert alert-info">
              <strong>{{ session()->get('add')}} </strong> <!-- create event -->
          </div>
        </div>
        @endif
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ route('v-event_event.search') }}">
       {{ csrf_field() }}
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-sm-12">
          ...
          <a href="{{ route('inputevent.index') }}" class="btn btn-info">Buat Data</a>
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width = "23%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending"><center>Maksud Kegiatan</center></th>
                <th width = "14%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending"><center>Berangkat</center></th>
                <th width = "14%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending"><center>Kembali</center></th>
                ...
                <th width = "9%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending"><center>Aksi</center></th>
              </tr>
            </thead>
            <tbody>
            <?php
            ...
            @if($e -> status == '0')
                <tr role="row" class="odd">
                  ...
                  <td><a href="{{ route('belum-event_validasi.event', ['id' => $e->id]) }}" class="btn btn-info col-sm-12 btn-info">Tinjau</a>
                  </td>
              </tr>
              @endif
              @endforeach
