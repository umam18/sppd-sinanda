@extends('pegawai.validasi.base2')
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/input.css') }}">
      ...
      <h2><b><center>EDIT SPD</center></b></h2>
      <button class="btn-btn warning" onclick="myFunction()">Edit</button>
      <hr style="border-width: 2px; border-color: black;"></hr>

<form method="POST" id="myForm" name="vform" action="{{ route('spd-spd.update', ['id' => $spd->id]) }}" enctype="multipart/form-data">
{{ csrf_field() }}
