...
{{ csrf_field() }}
        ...
        <hr style="border-width: 2px; border-color: black;"></hr>
            ...
            <div class="event">
              <div class="pejabat">
              <h4>Dalam Rangka</h4>
                  <input name="maksud" type="text area" style="width: 200px;" placeholder="Maksud Perjalanan Dinas" size="36" required></input>
              </div>
              ...
              <h4>Lama Perjalanan</h4>
                <input required type="number" min="0" name="lama" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"></input>
              </div>
        ...
        <hr style="border-width: 2px; border-color: black;"></hr>
              ...
              <div id="tujuan2" class="form-group">
                </div>
...
<!-- TUJUAN -->
 ...
 <!-- TRANSPORT KU -->
  ...
  $('#tujuan').change(function(){
  $('#angkutan').empty();  
  $('#angkutan').append('<h4>Transportasi</h4><select style="width:150px;" id="trans" name="transportasi" required><option hidden value="">- Transportasi -</option><option value="Pesawat">Pesawat</option><option value="Angkutan Darat">Angkutan Darat</option><option value="Angkutan Darat (Kereta Api)">Kereta Api</option></select>')
  var kabupatenID = $(this).val();    
  if(kabupatenID){
      $.ajax({
          type:"GET",
