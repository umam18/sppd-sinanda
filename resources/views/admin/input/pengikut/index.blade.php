...
<form method="POST" id="myForm" name="vform" onsubmit="return Validate()" action="{{ route('pengikut.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
