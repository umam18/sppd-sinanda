          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width = "24%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending"><center>Tujuan</center></th>
            ...
            @foreach($event as $count => $e)
             @if ($e->status == '1')
                <tr role="row" class="odd">
                  ...
                  <td><a href="{{ route('sudah_validasi.event', ['id' => $e->id]) }}" class="btn btn-info col-sm-12 btn-info">Tinjau</a></td>
              </tr>
              @endif
              @endforeach
            </tbody>
