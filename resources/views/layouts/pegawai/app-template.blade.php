...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/jquery-ui-1.8.9.custom.css') }}" type="text/css" />
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <script src="{{ asset("/bower_components/AdminLTE/plugins/wizard/script.js") }}" type="text/javascript"></script>
    <script src="{{ asset("/bower_components/AdminLTE/plugins/wizard/script.min.js") }}" type="text/javascript"></script>
