...
class VP_SpdController extends Controller
{
    /**
    ...
    public function belum()
    {
      ...
      ->select('spd.*')
      ->paginate(10);
      return view('pegawai/validasi/belum', ['spd' => $spd]);
    }
    ...
    public function sudah()
    {
      ...
      ->select('spd.*')
      ->paginate(10);
      return view('pegawai/validasi/sudah', ['spd' => $spd]);
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      ->update(['status' => 1]);
        ...
        return view('/pegawai/dashboard', ['spd' => $spd]);
    }
    ...
    public function edit_spd($id)
    {
      ...
      ->get();
        ...
        if ($spd == null || count($spd) == 0) {
            return view('pegawai/validasi/belum');
        }
        return view('pegawai/validasi/spd', ['spd' => $spd, 'data' => $data, 'kode' => $kode,
    ...
    public function update_spd(Request $request, $id)
    {
        ...
        // return redirect()->action('VP_SpdController@belum');
    }
   ...
   private function createQueryInput($keys, $request) {
    ...
    public function search(Request $request) {
       ...
       return view('pegawai/validasi/belum', ['spd' => $spd,   'searchingVals' => $constraints]);
    }
    ...
    public function search2(Request $request) {
       ...
       $spd = $this->doSearchingQuery($constraints);
       return view('pegawai/validasi/sudah', ['spd' => $spd,   'searchingVals' => $constraints]);
    }
