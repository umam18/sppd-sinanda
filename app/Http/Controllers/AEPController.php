...
class AEPController extends Controller
{
    ...
    public function store(Request $request)
    {
     ...
     private function validateInput($request)
     {
        ...
        'h_ku' => 't_ku', 'n_transport' => 'required', 'no_berangkat' => 'required', 'no_kembali' => 'required', 'h_tiket' => 'required', 't_transport' => 'required', 'n_penginapan' => 'required', 'j_penginapan' => 'required', 'h_penginapan' => 'required', 't_penginapan' => 'required', 'j_hn' => 'required', 'h_hn' => 'required', 't_hn' => 'required', 'j_fd' => 'required', 'h_tiketp' => 'required', 'nk_transport' => 'required', 
