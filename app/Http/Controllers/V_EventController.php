...
class V_EventController extends Controller
{
    /**
    ...
    public function lihat_belum()
    {
      ...
      ->select('event.*')
      ->paginate(10);
      return view('admin/validasi/event/lihat_belum', ['event' => $event]);
    }
    ...
    public function lihat_sudah()
    {
      ...
      ->select('event.*')
      ->paginate(10);
      return view('admin/validasi/event/lihat_sudah', ['event' => $event]);
    }
    ...
    public function belum($id)
    {
      ...
      $add = DB::table('event')
      ->find($id);
      return view('admin/validasi/event/belum', ['event' => $event, 'add' => $add]);
    }
    ...
    public function sudah($id)
    {
      ...
      ->select('*')
      ->paginate(10);
      return view('admin/validasi/event/sudah', ['event' => $event]);
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      session()->flash('validasi_event', 'Nominatif Telah Divalidasi!');

      return redirect()->action('V_EventController@lihat_belum');
    }
    ...
    public function update_event(Request $request, $id)
    {
      ...
      session()->flash('validasi_event', 'Data Telah Divalidasi!');
    ...
    public function edit_espd($id)
    {
      ...
      ->get();
        ...
        ->find($id);
        return view('admin/validasi/event/espd', ['event' => $event, 'data' => $data, 'kode' => $kode,
   ...
   private function createQueryInput($keys, $request) {
    ...
    public function search(Request $request) {
       ...
       // return back()->withInput(['event' => $event,   'searchingVals' => $constraints]);
       return view('admin/validasi/event/lihat_belum', ['event' => $event,   'searchingVals' => $constraints]);
    }
    ...
    private function prepareExportingData($request, $id) {
        ...
        $excel->sheet('Nominatif', function($sheet) use($akun, $event, $id) {
          ...
          $sheet->setFontSize(8);
          $sheet->setBorder('A12:M13', 'double');
          $sheet->mergeCells('B12:C13'); $sheet->mergeCells('D12:D13'); $sheet->mergeCells('E12:E13'); $sheet->mergeCells('F12:F13'); $sheet->mergeCells('I12:I13'); $sheet->mergeCells('J12:J13'); $sheet->mergeCells('A12:A13');  $sheet->mergeCells('A1:N1');  $sheet->mergeCells('A2:N2');  $sheet->mergeCells('A3:N3');  $sheet->mergeCells('A4:N4');
